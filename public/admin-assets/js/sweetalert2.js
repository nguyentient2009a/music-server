!function (t, e) {
    ...
    function ht(t, e) {
        ...
        e.showConfirmButton || e.showDenyButton || e.showCancelButton || at(a),
            ...
            (r = e).buttonsStyling ? (vt([n, o, i], $.styled),
                ...
                r.cancelButtonColor && (i.style.backgroundColor = r.cancelButtonColor)) : yt([n, o, i], $.styled),
    ...
    var gt, vt = function (t, e) {
        ...
        var e, n, o, i, r, a = !!(i = k()) && (i.parentNode.removeChild(i),
            yt([document.documentElement, document.body], [$["no-backdrop"], $["toast-shown"], $["has-column"]]),
            !0);
    ...
    var Re = ["swal-title", "swal-html", "swal-footer"]
        ...
        , Ue = function (t) {
            ...
            return g(t.querySelectorAll("swal-button")).forEach(function (t) {
                ...
                i["".concat(e, "ButtonText")] = t.innerHTML,
                    i["show".concat(m(e), "Button")] = !0,
                    n && (i["".concat(e, "ButtonColor")] = n),
                    i["".concat(e, "ButtonAriaLabel")] = o
            }),
                i
        }
        , _e = function (t) {
        ...
        , en = function (e, n) {
            ...
            var i = E();
            y(n.inputOptions) || w(n.inputOptions) ? ($t(),
        ...
        , mn = function (t, e, n) {
            ...
            o.stopKeydownPropagation && e.stopPropagation(),
                "Enter" === e.key ? hn(t, e, o) : "Tab" === e.key ? gn(e, o) : -1 !== [].concat(dn, pn).indexOf(e.key) ? vn(e.key) : -1 !== fn.indexOf(e.key) && yn(e, o, n)
        }
        , hn = function (t, e, n) {
    ...
    function Bn(a, c, s) {
        return new Promise(function (t) {
            ...
            ke.swalPromiseResolve.set(a, t),
                ...
                r = c,
                t = e,
                Tt.innerParams.get(n).toast ? bn(n, r, t) : (Cn(r),
                    kn(r),
                    An(n, r, t)),
                o = a,
                r = s,
                ...
                (s.toast && (s.input || s.footer || s.showCloseButton) ? vt : yt)(document.body, $["toast-column"]),
                r = a,
                "select" === (t = s).input || "radio" === t.input ? en(r, t) : -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(t.input) && (y(t.inputValue) || w(t.inputValue)) && nn(r, t),
                Ie(s),
                En(ee, s, e),
                Sn(c, s),
                setTimeout(function () {
